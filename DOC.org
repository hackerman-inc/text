...
path_to_license_file                -- path to license file, e.g. /Users/michael/Desktop/license.json
...
-- Important: Use Comma, Period, Plus, Minus for symbols , . + -
...
-- pane navigation
focus_main_editor                   Cmd + Shift + Comma
focus_split_editor                  Cmd + Shift + Period
previous_tab                        Cmd + Comma
next_tab                            Cmd + Period

-- quick switch to buffer
...
-- List your custom functions here, set key binding using same format as above
